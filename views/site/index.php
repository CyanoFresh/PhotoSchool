...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">Также тут можно ознакомится с нашими услугами: аренда фотостудии в Ирпене, фотограф, дизайнер.
    ...
    <div class="jumbotron">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <p class="lead">Создание альбома на 24 страницы (кол-во старниц может меняться по желанию):</br>
                    20х15 см - 250 грн</br>
                    15х20 см - 250 грн</br>
                    20х20 см - 270 грн</br>
                    30х20 см - 350 грн</br>
    ...
    <div class="jumbotron text-center">
            ...
            <h1>Заполните анкету, пожалуйста, если желаете, чтоб Вас или Вашего ребенка сфотографировали в
