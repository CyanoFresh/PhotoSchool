...
<div class="site-index">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">Этапы работы при создании альбома:</br>
            ...
            2 - общая фотосъемка группами. Продолжительность съемки зависит от количества страниц в альбоме ( 2 - 4 часа). Съемка может проходить на природе, в учебном заведении.</br>
            3 - оформление и печать выпускных альбомов.</br>
